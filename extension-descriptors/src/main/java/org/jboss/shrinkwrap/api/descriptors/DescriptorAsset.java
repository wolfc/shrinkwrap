...
/**
 * Represents a {@link Descriptor} as an {@link Asset} capable
...
public class DescriptorAsset implements NamedAsset
{
   ...
   /**
    * Underlying descriptor; immutable
    */
    ...
    * {@link Descriptor} as backing content
    * @param descriptor
    */
   public DescriptorAsset(final Descriptor descriptor) throws IllegalArgumentException
   {
